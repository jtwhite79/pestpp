...
const std::vector<OptionSpec>& PestppOptions::get_option_registry()
{
    ...
    OptionSpec{ "GLM_IRLS_EPS", {}, OptType::DOUBLE, "glm", false,
        [](PestppOptions& o,const string& value,const string&)->PestppOptions::ARG_STATUS{ double x; convert_ip(value,x); o.set_glm_irls_eps(x); return PestppOptions::ARG_STATUS::ARG_ACCEPTED; },
        [](PestppOptions& o){ o.set_glm_irls_eps(-1.0); },
        [](const PestppOptions& o)->string{ std::ostringstream ss; ss<<o.get_glm_irls_eps(); return ss.str(); } },
    OptionSpec{ "GLM_IRLS_START_ITER", {}, OptType::INT, "glm", false,
        [](PestppOptions& o,const string& value,const string&)->PestppOptions::ARG_STATUS{ int x; convert_ip(value,x); o.set_glm_irls_start_iter(x); return PestppOptions::ARG_STATUS::ARG_ACCEPTED; },
        [](PestppOptions& o){ o.set_glm_irls_start_iter(1); },
        [](const PestppOptions& o)->string{ return std::to_string(o.get_glm_irls_start_iter()); } },
    ...
    OptionSpec{ "IES_USE_ENIF", {}, OptType::BOOL, "ies", false,
        [](PestppOptions& o,const string& value,const string&)->PestppOptions::ARG_STATUS{ o.set_ies_use_enif(pest_utils::parse_string_arg_to_bool(value)); return PestppOptions::ARG_STATUS::ARG_ACCEPTED; },
        [](PestppOptions& o){ o.set_ies_use_enif(false); },
        [](const PestppOptions& o)->string{ return std::to_string(o.get_ies_use_enif()?1:0); } },
    OptionSpec{ "IES_ENIF_RIDGE", {}, OptType::DOUBLE, "ies", false,
        [](PestppOptions& o,const string& value,const string&)->PestppOptions::ARG_STATUS{ double x; convert_ip(value,x); o.set_ies_enif_ridge(x); return PestppOptions::ARG_STATUS::ARG_ACCEPTED; },
        [](PestppOptions& o){ o.set_ies_enif_ridge(1.0e-6); },
        [](const PestppOptions& o)->string{ std::ostringstream ss; ss<<o.get_ies_enif_ridge(); return ss.str(); } },
    OptionSpec{ "IES_ENIF_RESID_INFLATE", {}, OptType::BOOL, "ies", false,
        [](PestppOptions& o,const string& value,const string&)->PestppOptions::ARG_STATUS{ o.set_ies_enif_resid_inflate(pest_utils::parse_string_arg_to_bool(value)); return PestppOptions::ARG_STATUS::ARG_ACCEPTED; },
        [](PestppOptions& o){ o.set_ies_enif_resid_inflate(true); },
        [](const PestppOptions& o)->string{ return std::to_string(o.get_ies_enif_resid_inflate()?1:0); } },
    OptionSpec{ "IES_ENIF_GRAPH", {}, OptType::STRING, "ies", false,
        [](PestppOptions& o,const string& value,const string& org_value)->PestppOptions::ARG_STATUS{ o.set_ies_enif_graph(org_value); return PestppOptions::ARG_STATUS::ARG_ACCEPTED; },
        [](PestppOptions& o){ o.set_ies_enif_graph(""); },
        [](const PestppOptions& o)->string{ return o.get_ies_enif_graph(); } },
    OptionSpec{ "IES_ENIF_H_LASSO", {}, OptType::DOUBLE, "ies", false,
        [](PestppOptions& o,const string& value,const string&)->PestppOptions::ARG_STATUS{ double x; convert_ip(value,x); o.set_ies_enif_h_lasso(x); return PestppOptions::ARG_STATUS::ARG_ACCEPTED; },
        [](PestppOptions& o){ o.set_ies_enif_h_lasso(0.0); },
        [](const PestppOptions& o)->string{ std::ostringstream ss; ss<<o.get_ies_enif_h_lasso(); return ss.str(); } },
    OptionSpec{ "IES_ENIF_H_CV_FOLDS", {}, OptType::INT, "ies", false,
        [](PestppOptions& o,const string& value,const string&)->PestppOptions::ARG_STATUS{ int x; convert_ip(value,x); o.set_ies_enif_h_cv_folds(x); return PestppOptions::ARG_STATUS::ARG_ACCEPTED; },
        [](PestppOptions& o){ o.set_ies_enif_h_cv_folds(0); },
        [](const PestppOptions& o)->string{ return std::to_string(o.get_ies_enif_h_cv_folds()); } },
    OptionSpec{ "IES_ENIF_SHRINK", {}, OptType::DOUBLE, "ies", false,
        [](PestppOptions& o,const string& value,const string&)->PestppOptions::ARG_STATUS{ double x; convert_ip(value,x); o.set_ies_enif_shrink(x); return PestppOptions::ARG_STATUS::ARG_ACCEPTED; },
        [](PestppOptions& o){ o.set_ies_enif_shrink(1.0e-3); },
        [](const PestppOptions& o)->string{ std::ostringstream ss; ss<<o.get_ies_enif_shrink(); return ss.str(); } },
    OptionSpec{ "IES_ENIF_ORDER", {}, OptType::STRING, "ies", false,
        [](PestppOptions& o,const string& value,const string&)->PestppOptions::ARG_STATUS{ o.set_ies_enif_order(value); return PestppOptions::ARG_STATUS::ARG_ACCEPTED; },
        [](PestppOptions& o){ o.set_ies_enif_order("amd"); },
        [](const PestppOptions& o)->string{ return o.get_ies_enif_order(); } },
    OptionSpec{ "IES_ENIF_SAVE_H", {}, OptType::BOOL, "ies", false,
        [](PestppOptions& o,const string& value,const string&)->PestppOptions::ARG_STATUS{ o.set_ies_enif_save_h(pest_utils::parse_string_arg_to_bool(value)); return PestppOptions::ARG_STATUS::ARG_ACCEPTED; },
        [](PestppOptions& o){ o.set_ies_enif_save_h(false); },
        [](const PestppOptions& o)->string{ return std::to_string(o.get_ies_enif_save_h()?1:0); } },
    OptionSpec{ "IES_USE_PRIOR_PREC", {}, OptType::BOOL, "ies", false,
        [](PestppOptions& o,const string& value,const string&)->PestppOptions::ARG_STATUS{ o.set_ies_use_prior_prec(pest_utils::parse_string_arg_to_bool(value)); return PestppOptions::ARG_STATUS::ARG_ACCEPTED; },
        [](PestppOptions& o){ o.set_ies_use_prior_prec(false); },
        [](const PestppOptions& o)->string{ return std::to_string(o.get_ies_use_prior_prec()?1:0); } },
    ...
    OptionSpec{ "IES_REINFLATE_SOLVER", {}, OptType::VEC_STRING, "ies", false,
        [](PestppOptions& o,const string& value,const string& org_value)->PestppOptions::ARG_STATUS{ vector<string> v; vector<string> tok; tokenize(value,tok,","); for(const auto& t:tok){ v.push_back(lower_cp(strip_cp(t))); } o.set_ies_reinflate_solver(v); return PestppOptions::ARG_STATUS::ARG_ACCEPTED; },
        [](PestppOptions& o){ o.set_ies_reinflate_solver(vector<string>()); },
        [](const PestppOptions& o)->string{ std::ostringstream ss; auto v=o.get_ies_reinflate_solver(); for(size_t i=0;i<v.size();++i){if(i)ss<<",";ss<<v[i];} return ss.str(); } },
    ...
    OptionSpec{ "PANTHER_AGENT_MAX_FAILED_RUN_DELTA", {}, OptType::INT, "panther", false,
        [](PestppOptions& o,const string& value,const string&)->PestppOptions::ARG_STATUS{ int x; convert_ip(value,x); o.set_panther_agent_max_failed_run_delta(x); return PestppOptions::ARG_STATUS::ARG_ACCEPTED; },
        [](PestppOptions& o){ o.set_panther_agent_max_failed_run_delta(3); },
        [](const PestppOptions& o)->string{ return std::to_string(o.get_panther_agent_max_failed_run_delta()); } },
